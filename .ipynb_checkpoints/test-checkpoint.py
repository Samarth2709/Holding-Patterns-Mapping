...
json_data = json.load(open(r'C://Users/samar/Desktop/Holding_patterns_mapping/Geo-json/states.json', 'r'))
...
fig = px.choropleth(df, geojson=json_data, locations='ID', color='Random_Data', scope="usa", color_continuous_scale="Viridis", range_color=(0, 50))
fig.show()